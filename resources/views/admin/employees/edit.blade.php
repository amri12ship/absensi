            ...
            <form method="POST" action="{{ route('admin.employees.update', $employee) }}">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="nik" value="{{ old('nik', $employee->employee?->nik) }}" class="form-control @error('nik') is-invalid @enderror" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="position" value="{{ old('position', $employee->employee?->position) }}" class="form-control @error('position') is-invalid @enderror" required>
                        @error('position')<div class="invalid-feedback">{{ $message }}</div>@enderror
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Password</label>
                        <input type="password" name="password" class="form-control @error('password') is-invalid @enderror"
                               placeholder="Kosongkan jika tidak diganti" autocomplete="new-password">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="phone" value="{{ old('phone', $employee->employee?->phone) }}" class="form-control @error('phone') is-invalid @enderror">
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="address" rows="3" class="form-control @error('address') is-invalid @enderror">{{ old('address', $employee->employee?->address) }}</textarea>
